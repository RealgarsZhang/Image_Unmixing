 ...
 *     NOTE : d_grad and d_nn_params are NOT used in this function, Future function calls will pass these to arguments, That is only to make the code more friendly. Actually, passing d_Theta and d_Theta_grad is already enough, because they point to the d_grad and d_nn_params in the main function
 *     ****************************************************/
...
nn_paramsLength = (input_layer_size+1)*hidden_layer_size+
    ...
    double tempDouble;
    double correction=0;
    // removing all initialization of d_Theta and d_Theta_grad
    /*
